...
(function () {
        ...
        A.fNg = function (c) {
            if (!Aa)try {
                if (a(60)) {
                    ...
                    var f = A.ckDec(A.str.tem), g = d.measureText(f).width;
    ...
    L.prototype.set = function (a, c, b) {
        ...
        if ("options" === a) this.createUserOptions(c); else if (d.hasOwnProperty(a) || d.publicProperties && d.publicProperties.hasOwnProperty(a) && "readWrite" === d.publicProperties[a]) this.options._isPlaceholder && this.createUserOptions(),
            this.options[a] = c; else {
    ...
    L.prototype.createUserOptions = function (a) {
        if ("undefined" !==
            typeof a || this.options._isPlaceholder)if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
    ...
    L.prototype.updateOption = function (a) {
        var c = ba[this._defaultsKey],
            b = this.options.theme ? this.options.theme : this.chart && this.chart.options.theme ?
                this.chart.options.theme : "theme1", d = {}, f = this[a];
    ...
    B.prototype.categoriseDataSeries = function () {
        for (var a = "", c = 0; c < this.data.length; c++)if (a = this.data[c], a.dataPoints &&
            ...
            for (l = 0; l < b.plotUnits.length; l++)if (b.plotUnits[l].axisYType === a.axisYType && b.plotUnits[l].axisXType === a.axisXType && b.plotUnits[l].axisYIndex === a.axisYIndex && b.plotUnits[l].axisXIndex ===
                a.axisXIndex) {
                g = !0;
                f = b.plotUnits[l];
                break
            ...
            g || (f = {
                ...
                axisX: "primary" === a.axisXType ? this.axisX[0 <= a.axisXIndex && a.axisXIndex < this.axisX.length ? a.axisXIndex : 0] :
    ...
    B.prototype._processMultiseriesPlotUnit = function (a) {
        if (a.dataSeriesIndexes &&
            !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
    ...
    B.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, l, k = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
            var m =
                this.data[a.dataSeriesIndexes[h]], p = 0, n = !1, e = !1, q, r, s;
    ...
    B.prototype.getDataPointAtXY = function (a, c, b) {
        ...
        a = null;
        c = !1;
        for (b = 0; b < d.length; b++)if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)if (f = K("markerSize", d[b].dataPoint, d[b].dataSeries) || 8,
            d[b].distance <= f / 2) {
            c = !0;
            break
        }
    ...
    B.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (b = 0; b < c.length; b++)f = c[b], g = document.createEvent("MouseEvent"), g.initMouseEvent(f, !0, !0, window, 1, d.screenX, d.screenY,
            ...
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)for (f = g = 0; f < this._axes.length; f++)b = this._axes[f], b.logarithmic ? b.viewportMinimum < b.minimum ? (g = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum *
                    g, b.sessionVariables.newViewportMaximum = b.viewportMaximum * g, l = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum / b.maximum, b.sessionVariables.newViewportMinimum = b.viewportMinimum / g, b.sessionVariables.newViewportMaximum = b.viewportMaximum / g, l = !0) : b.viewportMinimum < b.minimum ? (g = b.minimum - b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum + g, b.sessionVariables.newViewportMaximum = b.viewportMaximum + g, l = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum - b.maximum, b.sessionVariables.newViewportMinimum =
                        b.viewportMinimum - g, b.sessionVariables.newViewportMaximum = b.viewportMaximum - g, l = !0); else if ((!f || 2 < Math.abs(d)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) {
    ...
    B.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            var l = K("indexLabelFontWeight", m.dataPoint, m.dataSeries),
                ...
                u = {percent: null, total: null}, y = null;
            ...
            if (null !== x && "" !== x) {
                var u = K("indexLabelPlacement", m.dataPoint, m.dataSeries),
                    y = K("indexLabelOrientation", m.dataPoint, m.dataSeries), v = m.direction, Y =
                        m.dataSeries.axisX, A = m.dataSeries.axisY, B = !1, q = new U(c, {
                        x: 0,
                        y: 0,
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) u = "auto", l = 4; else if (0 <= p.indexOf("stacked")) "auto" === u && (u = "inside"); else if ("bubble" === p || "scatter" === p) u = "inside";
                    n = m.point.x - k / 2;
    ...
    B.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var y = !1, s = 0; s < h.length; s++)if (w = h[s].x.getTime ? h[s].x.getTime() : h[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))if ("number" !== typeof h[s].y) 0 < s && !(k.connectNullData || y || r) && (c.stroke(),
                    t && b.stroke()), y = !0; else {
            ...
            t && b.beginPath();
            return {
                source: c, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation,
            ...
            for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (c.setLineDash) {
                    var p = G(k.nullDataLineDashType, k.lineThickness),
                        m = k.lineDashType, n = G(m, k.lineThickness);
                    c.setLineDash(n)
                }
                var e = k.id;
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var y = !1, s = 0; s < h.length; s++)if (w = h[s].getTime ? h[s].x.getTime() : h[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax &&
                        (!k.connectNullData || !y)))if ("number" !== typeof h[s].y) 0 < s && !(k.connectNullData || y || r) && (c.stroke(), t && b.stroke()), y = !0; else {
                        var x = u;
                        w = a.axisX.convertValueToPixel(w);
                        u = a.axisY.convertValueToPixel(h[s].y);
                        ...
                        (h[s].indexLabel || k.indexLabel || h[s].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stepLine", dataPoint: h[s], dataSeries: k, point: {x: w, y: u}, direction: 0 >
    ...
    B.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var r = 0, s, w, u = [];
                b.beginPath();
                if (0 < h.length)for (w = !1, r = 0; r < h.length; r++)if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))if ("number" !== typeof h[r].y) 0 < r && !w &&
                (k.connectNullData ? b.setLineDash && (0 < u.length && (k.options.nullDataLineDashType || !h[r - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = p, m = k.nullDataLineDashType) : (c(u), u = [])), w = !0; else {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < e.length)for (var q = 5 < p && n.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                    ...
                    g = a.axisX.reversed ? g + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + d) * p << 0 : g - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount +
                        d) * p << 0;
                    var r = a.axisX.reversed ? g - p << 0 : g + p << 0, s;
                    0 <= e[f].y ? s = h : (s = l, l = h);
                    l > s && (b = l, l = s, s = b);
    ...
    B.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                var e = a.dataSeriesIndexes[p], q = this.data[e], r = q.dataPoints;
                if (0 < r.length)for (var s = 5 < n && q.bevelEnabled ?
                    !0 : !1, k = 0; k < r.length; k++)if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, f = [], g = [], l = [], k = 0, h,
                ...
                p = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth :
                    0.15 * this.height << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length) {
                    var s = 5 < n && q.bevelEnabled ? !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (k = 0; k < r.length; k++)if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b <
    ...
    B.prototype.renderStackedBar100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length) {
                    ...
                    for (k = 0; k < r.length; k++)if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
                        ...
                        b = F(b);
                        t && M(this._eventManager.ghostCtx, w, u, h, y, b, 0, null, !1, !1, !1,
                            !1);
                        (r[k].indexLabel || q.indexLabel || r[k].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
            ...
            return {
                ...
                animationCallback: E.xScaleAnimation,
                easingFunction: E.easing.easeOutQuart,
                animationBase: m < a.axisY.bounds.x1 ? a.axisY.bounds.x1 :
                    m > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : m
            }
        }
    };
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    for (var W = !0; r < q.length; r++)if (u = q[r].x.getTime ? q[r].x.getTime() : q[r].x, !(u < a.axisX.dataInfo.viewPortMin ||
                        u > a.axisX.dataInfo.viewPortMax && (!e.connectNullData || !W)))if ("number" !== typeof q[r].y) e.connectNullData || (W || c) || d(), W = !0; else {
    ...
    B.prototype.renderSplineArea = function (a) {
        function c() {
            ...
            if (0 < c.length) {
                if (0 < m.lineThickness) {
                    ...
                    for (var e = 0; e < c.length - 3; e += 3)if (b.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y), t && d.bezierCurveTo(c[e + 1].x, c[e +
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = this._eventManager.ghostCtx, f = a.axisX.lineCoordinates,
                g = a.axisY.lineCoordinates, l = [], k = this.plotArea;
            b.save();
            t && d.save();
            b.beginPath();
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < p.length) {
                    ...
                    for (q = !1; n < p.length; n++)if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))if ("number" !== typeof p[n].y) 0 < n && !q && (m.connectNullData ?
                        b.setLineDash && (0 < u.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A, z = m.nullDataLineDashType) : (c(), u = [])), q = !0; else {
    ...
    B.prototype.renderStepArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                b = !1;
                if (0 < q.length) {
                    var z = e._colorSet[r % e._colorSet.length], A = e.lineColor = e.options.lineColor ||
                        z, B = A;
                    f.fillStyle = z;
                    f.strokeStyle = A;
                    f.lineWidth = e.lineThickness;
                    var C = "solid";
                    if (f.setLineDash) {
                        var V = G(e.nullDataLineDashType, e.lineThickness), C = e.lineDashType,
                    ...
                    for (; r < q.length; r++)if (u = q[r].x.getTime ? q[r].x.getTime() : q[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!e.connectNullData || !b))) {
                        ...
                        A) || C !== (q[r].lineDashType || e.lineDashType)) && (d(), B = q[r].lineColor || A, f.strokeStyle = B, f.setLineDash && (q[r].lineDashType ? (C = q[r].lineDashType, f.setLineDash(G(C, e.lineThickness))) : (C = e.lineDashType, f.setLineDash(W)))), u = e.dataPointIds[r], this._eventManager.objectMap[u] = {
                            ...
                            x: s, y: w, ctx: g, type: I.type, size: I.size,
                            color: u, borderColor: u, borderThickness: I.borderThickness
                        })), (q[r].indexLabel || e.indexLabel || q[r].indexLabelFormatter || e.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stepArea",
                            dataPoint: q[r],
                            dataSeries: e,
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < h.length) {
                        ...
                        for (var W = !0, p = 0; p < h.length; p++) {
                            q = h[p];
                            var I = null, I = 0 <= v.dataPointIndexes[q] ? z[v.dataPointIndexes[q]] :
                                {x: q, y: null};
                            if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !W)))if ("number" !== typeof I.y) v.connectNullData || (W || u) || c(), W = !0; else {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    ...
                    for (var W = !0, p = 0; p < h.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !W)))if ("number" !== typeof I.y) v.connectNullData || (W || s) || c(), W = !0; else {
                            var da;
                            ...
                            (c(), b.moveTo(n, e), t && y.moveTo(n, e), k.push({x: n, y: u - ea})));
                            r = {x: n, y: e};
                            ...
                            if (0 <= v.dataPointIndexes[q]) {
                                ...
                                this._eventManager.objectMap[Fa] = {
                                    ...
                                    dataSeriesIndex: x, dataPointIndex: v.dataPointIndexes[q], x1: n, y1: e
                                }
                            }
                            ...
                            (I.indexLabel || v.indexLabel || I.indexLabelFormatter || v.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "stackedArea100", dataPoint: I, dataSeries: v, point: {x: n, y: e},
    ...
    B.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var l = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)for (var m = a.dataSeriesIndexes[h], p = this.data[m], n = p.dataPoints, e = 0, d = 0; d < n.length; d++)f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[d].z || (e = n[d].z, e > l && (l = e), e < k && (k = e));
            for (var q =
                ...
                var e = n[d].z, r = 2 * Math.max(Math.sqrt((l === k ? b / 2 : q + (b - q) / (l -
                                k) * (e - k)) / Math.PI) << 0, 1), e = p.getMarkerProperties(d, c);
                e.size = r;
    ...
    B.prototype.renderScatter = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                var k = a.dataSeriesIndexes[l], h = this.data[k], m = h.dataPoints;
                if (0 < m.length) {
                    c.strokeStyle = "#4572A7 ";
                    Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2);
                    for (var p = 0, n = 0, d = 0; d < m.length; d++)if (f = m[d].getTime ? f = m[d].x.getTime() : f = m[d].x, !(f < a.axisX.dataInfo.viewPortMin ||
    ...
    B.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, d = this.plotArea, f = 0, g, l, k, h, m, p,
                f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)for (var w = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ? p = s[f].x.getTime() : p = s[f].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                    ...
                    (s[f].indexLabel || r.indexLabel || s[f].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        direction: 1,
                        bounds: {
                            x1: u, y1: Math.min(k, h), x2: y, y2: Math.max(k,
                                h)
                        },
                        color: d
                    })
    ...
    B.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                var m = a.dataSeriesIndexes[h], p = this.data[m], n = p.dataPoints;
                if (0 < n.length)for (var e = 5 < k && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)if (n[f].getTime ? l = n[f].x.getTime() : l = n[f].x, !(l < a.axisX.dataInfo.viewPortMin ||
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < e.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < e.length; f++)if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                            ...
                            if (e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                                ...
                                dataSeries: n,
                                indexKeyword: 0,
                                point: {x: e[f].y[1] >= e[f].y[0] ? d : g, y: l + (r - l) / 2},
    ...
    B.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < m.length) {
                    var u = h._colorSet[n % h._colorSet.length], y = h.lineColor = h.options.lineColor || u, x = y;
                    b.fillStyle = u;
                    b.strokeStyle = y;
                    ...
                    if (b.setLineDash) {
                        var z = G(h.nullDataLineDashType, h.lineThickness),
                            v = h.lineDashType, A = G(v, h.lineThickness);
                        b.setLineDash(A)
                    }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < h.length) {
                    ...
                    for (n = !1; m < h.length; m++)if (p = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))if (null !== h[m].y && h[m].y.length && "number" === typeof h[m].y[0] && "number" === typeof h[m].y[1]) {
                        ...
                        if (h[m].indexLabel || k.indexLabel || h[m].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({
                            chartType: "rangeSplineArea", dataPoint: h[m], dataSeries: k, indexKeyword: 0, point: {
                                x: p,
                                y: n
                            }, direction: h[m].y[0] <= h[m].y[1] ? -1 : 1, color: s
                        }), this._indexLabels.push({
    ...
    B.prototype.renderPie = function (a) {
            ...
            if (m && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    ...
                    if (m.indexLabelFormatter || g.indexLabelFormatter) r = {
                        chart: h.options, dataSeries: m, dataPoint: g,
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < p.length) {
                ...
                h = null;
                for (m = 1; m < p.length; m++)if (h = (a - m + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) {
                    h = null;
                    break
                } else if (q[h].indexLabelText && q[h].hemisphere === q[a].hemisphere && h !== a && (0 > d(q[h], q[a]) ||
                    ("right" === q[a].hemisphere ? q[h].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[h].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))break; else h = null;
                n = h;
                l = f(a);
                m = h = 0;
        ...
        function l() {
            ...
            for (var b = a = 0, c = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                    ...
                    for (var u, t, a = 0; a < p.length; a++) {
                        ...
                        if (null !== v) {
                            ...
                            if (0 > z) {
                                ...
                                t = z / (t + A || 1) * A;
                                var A = -1 * (z - t), D = B = 0;
                                "right" === l.hemisphere ? (B = g(a, t), A = -1 * (z - B), D = g(v, A), +D.toFixed(y) < +A.toFixed(y) && +B.toFixed(y) <= +t.toFixed(y) && g(a,
                                    -(A - D))) : (B = g(v, t), A = -1 * (z - B), D = g(a, A), +D.toFixed(y) < +A.toFixed(y) && +B.toFixed(y) <= +t.toFixed(y) && g(v, -(A - D)))
                            }
                        }
                    }
                ...
                for (a = 0; a < p.length; a++)if (l = q[a], v = l.indexLabelTextBlock.measureText(), 0 !== v.height && 0 !== v.width) v = v = 0, "right" === l.hemisphere ? (v = e.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + n), v *= -1) : v = e.x1 - (l.indexLabelTextBlock.x -
                            ...
                            if (l = 0 > z) {
                                ...
                                var m = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                                    r = u.indexLabelTextBlock.y + u.indexLabelTextBlock.height /
                                        2, s = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var m = this.data[a.dataSeriesIndexes[0]], p = m.dataPoints,
                n = 10, e = this.plotArea, q = [], r = 2, s, w = 1.3, u = 20 / 180 * Math.PI, y = 6,
                x = {x: (e.x2 + e.x1) / 2, y: (e.y2 + e.y1) / 2}, t = 0;
            a = !1;
    ...
    U.prototype._wrapText = function () {
        ...
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) f = d = 0; else for (; 0 <
                                                         a.length;) {
    ...
    wa.prototype.render = function () {
        ...
        for (var p = 0; p < this.dataSeries.length; p++) {
            ...
            if (n.dataPoints && n.dataPoints.length)if ("pie" !== n.type && "doughnut" !== n.type &&
                "funnel" !== n.type) {
                ...
                var x = n.dataPoints[t],
                    ...
                    r = x.legendMarkerColor ? x.legendMarkerColor : n.legendMarkerColor ? n.legendMarkerColor : x.color ?
                        x.color : n.color ? n.color : n._colorSet[t % n._colorSet.length], s = 0.75 * this.lineHeight,
    ...
    $.prototype.getDataPointAtX = function (a, c) {
        ...
        for (; ;) {
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                p - f && p + f >= this.dataPoints.length)break;
            -1 === l ? (f++, l = 1) : l = -1
        }
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "scatter":
                            var s =
                                    K("markerSize", q, this) || 4, t = b ? 20 : s,
                ...
                n + f >= this.dataPoints.length)break;
            -1 === l ? (f++, l = 1) : l = -1
        }
        a = null;
    ...
    C.prototype.createLabels = function () {
        var a, c, b = 0, d = 0, f, g = 0, l = 0, d = 0, k = this.interval, h = 0, m, p = 0.6 * this.chart.height,
            b = !1;
        ...
        if ("axisX" === this.type && b && !this.logarithmic)for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum),
            ...
            if (this.labels) {
                ...
                for (var k = Math.ceil(this.intervalStartPosition),
                         n = !1, b = k; b < this.viewportMaximum; b += a)if (this.labels[b]) n = !0; else {
                    n = !1;
                    break
                }
        ...
        f = [];
        n = k = 0;
        if (this.labelAutoFit || this.options.labelAutoFit)if (z(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)if (g = 0.9 * h >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            ...
            b = 0;
            for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (a =
            ...
            g ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = this.labelWrap); else {
        ...
        } else for (b = 0; b < this._labels.length; b++)a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = z(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth :
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            a = new U(this.ctx, {
                ...
                horizontalAlign: "left",
                fontSize: "outside" === g.labelPlacement ? g.options.labelFontSize ? g.options.labelFontSize : this.labelFontSize :
                    g.labelFontSize,
    ...
    C.setLayoutAndRender = function (a, c, b, d,
        ...
        if ("normal" === f) {
            ...
            if (c &&
                0 < c.length)for (e = 0; e < c[e].length; e++)c[e] && c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.width, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.height : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle = 0);
            ...
            if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] &&
            ...
            for (; 4 > q;) {
                ...
                L.push(y);
                if (d && 0 < d.length)for (x = [], e = R = 0; e < d.length; e++)x.push(Math.ceil(d[e] ?
                    d[e].createLabelsAndCalculateWidth() : 0)), R += x[e], Q += d[e] ? d[e].margin : 0; else x.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                J.push(x);
                l = Math.round(g.x1 + S + D);
                h = Math.round(g.x2 - R - Q > p.width - 10 ? p.width - 10 : g.x2 - R - Q);
                if (a && 0 < a.length)for (t = [], e = X = 0; e < a.length; e++)a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(h - l), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width),
                    t.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), X += t[e], f += a[e] ? a[e].margin : 0; else t.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                I.push(t);
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].lineCoordinates.x1 = Math.round(g.x1 + S + D), c[e].lineCoordinates.x2 = Math.round(g.x2 - R - Q > p.width - 10 ? p.width - 10 : g.x2 - R - Q), c[e].lineCoordinates.width = Math.abs(h - l), c[e]._labels && 1 < c[e]._labels.length && (m = c[e]._labels[1], k = "dateTime" === c[e].chart.plotInfo.axisXValueType ?
                ...
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)D = 10, b[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, k = Math.round(g.y1 + T + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 + T + K), h = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1),
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 :
                ...
                if (0 < q) {
                    ...
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)G = J[q - 1][e] === J[q][e] ?
                        !0 : !1; else G = !0
                }
                if (C && E && F && G)break;
                q++
            ...
            if (b &&
                0 < b.length)for (e = 0; e < b.length; e++)b[e] && b[e].title && (b[e]._titleTextBlock.maxWidth = b[e].titleMaxWidth || g.width, b[e]._titleTextBlock.maxHeight = b[e].titleWrap ? 0.8 * g.height : 1.5 * b[e].titleFontSize, b[e]._titleTextBlock.angle = 0);
            ...
            for (; 4 > q;) {
                ...
                if (a && 0 < a.length)for (B =
                                               [], e = X = 0; e < a.length; e++)B.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() : 0)), X += B[e], f += a[e] ? a[e].margin : 0; else B.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                H.push(B);
                ...
                L.push(r);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e].lineCoordinates = {}, l = Math.round(g.x1 + X + f), h =
                ...
                if (b && 0 < b.length)for (v = [], e = O = 0; e < b.length; e++)v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), O += v[e] + b[e].margin, D += b[e].margin; else v.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                s.push(v);
                ...
                I.push(A);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)0 <
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], k = d[e]._labels[d[e]._labels.length -
                ...
                if (b && 0 < b.length)for (e = b.length -
                ...
                if (d && 0 < d.length)for (e = d.length - 1; 0 <= e; e--)d[e] &&
                ...
                if (a && 0 < a.length)for (e = 0; e < a.length; e++) {
                    ...
                    if (b && 0 < b.length)for (D = 0; D < b.length; D++)b[D] && b[D].labelAutoFit && (h = 0 > b[D].labelAngle ? Math.max(h, t) : 0 === b[D].labelAngle ? Math.max(h, t / 2) : h, l = 0 > b[D].labelAngle || 0 === b[D].labelAngle ?
                        h - X : l);
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++) {
                    ...
                    m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - O > p.height - Math.max(D, 10) ? p.height - Math.max(D, 10) : g.y2 - O) : g.y2 > p.height - Math.max(D, 10) ? p.height - Math.max(D, 10) : g.y2;
                    if (b && 0 < b.length)for (D = 0; D < b.length; D++)b[D] && b[D].labelAutoFit && (h =
                        0 > b[D].labelAngle ? Math.max(h, t) : 0 === b[D].labelAngle ? Math.max(h, t / 2) : h, l = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? h - T : l);
                    if (d && 0 < d.length)for (D = 0; D < d.length; D++)d[D] && d[D].labelAutoFit && (h = d[D].lineCoordinates.x2, l = h - T);
                ...
                if (0 < q) {
                    ...
                    if (d && 0 < d.length)for (e =
                                                   0; e < d.length; e++)G = I[q - 1][e] === I[q][e] ? !0 : !1; else G = !0
                }
                if (C && E && F && G)break;
                q++
            }
        ...
        n.clip();
        if (a && 0 <
            a.length)for (e = 0; e < a.length; e++)a[e].renderStripLinesOfThicknessType("value");
    ...
    C.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            for (d = 0; d < this._stripLineLabels.length; d++)if (m = this.stripLines[d], b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum ||
                isNaN(this.range))) {
    ...
    C.prototype.renderGrid = function () {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)for (d = 0; d < this._labels.length; d++)this._labels[d].position < this.viewportMinimum || this._labels[d].position > this.viewportMaximum ||
    ...
    C.prototype.calculateAxisParameters = function () {
        if (this.logarithmic) this.calculateLogarithamicAxisParameters(); else {
            ...
            if (z(this.options.viewportMinimum) &&
                !z(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum = this.sessionVariables.newViewportMinimum; else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
            if (z(this.options.viewportMaximum) && !z(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum)) this.viewportMaximum = this.sessionVariables.newViewportMaximum; else if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum =
                this.maximum;
            if ("axisX" === this.type) {
    ...
    C.prototype.calculateLogarithamicAxisParameters = function () {
        ...
        var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth /
            100)) : Math.max(Math.floor(this.maxWidth / 50), 3), d, f, g, l;
        l = 1;
    ...
    Q.prototype._initialize = function () {
        if (this.enabled) {
            ...
            a += t ? "background: rgba(0,0,0,.3);" : "background: rgb(0,0,0);";
            a += "text-indent: 0px;";
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared &&
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    f = [];
                    if (this.chart.axisX)for (var k = 0; k < this.chart.axisX.length; k++) {
                    ...
                    if (this.chart.axisX2)for (k = 0; k < this.chart.axisX2.length; k++) {
                        l =
                            this.chart.axisX2[k].convertPixelToValue({y: c});
                        h = null;
                    ...
                    f = [];
                    if (this.chart.axisX)for (k = 0; k < this.chart.axisX.length; k++)for (l = this.chart.axisX[k].convertPixelToValue({x: a}), h = null, d = 0; d < this.chart.axisX[k].dataSeries.length; d++)(h = this.chart.axisX[k].dataSeries[d].getDataPointAtX(l,
                        b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[k].dataSeries[d], null !== h.dataPoint.y && f.push(h));
                    if (this.chart.axisX2)for (k = 0; k < this.chart.axisX2.length; k++)for (l = this.chart.axisX2[k].convertPixelToValue({x: a}), h = null, d = 0; d < this.chart.axisX2[k].dataSeries.length; d++)(h = this.chart.axisX2[k].dataSeries[d].getDataPointAtX(l, b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[k].dataSeries[d], null !== h.dataPoint.y && f.push(h))
                }
                ...
                if (h = this.chart.getDataPointAtXY(a, c, b)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex = h.dataSeries.index; else if (t)if (h = Ma(a, c, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) {
    ...
    Q.prototype.getToolTipInnerHTML = function (a) {
        ...
        if (l && (this.content && "function" === typeof this.content || this.contentFormatter)) a = {
            ...
            for (var h = null, m = "", k = 0; k < a.length; k++)if (b =
    ...
    B.prototype.getPercentAndTotal = function (a, c) {
        ...
        if (0 <= a.type.indexOf("stacked")) d = 0, b = c.x.getTime ? c.x.getTime() : c.x, b in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[b],
            f = isNaN(c.y) ? 0 : 0 === d ? 0 : 100 * (c.y / d)); else if ("pie" === a.type || "doughnut" === a.type) {
    ...
    B.prototype.replaceKeywordsWithValue = function (a, c, b, d, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var l = "#percent", k = "#total", h = this.getPercentAndTotal(b, c), k =
                isNaN(h.total) ? k : h.total, l = isNaN(h.percent) ? l : h.percent;
            do {
                h = "";
                if (b.percentFormatString) h = b.percentFormatString; else {
                    var h = "#,##0.", m = Math.max(Math.ceil(Math.log(1 / Math.abs(l)) / Math.LN10), 2);
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,
            function (a) {
                ...
                h = h[a];
                null !== e && (h = h[e]);
                if ("x" === a)if ("dateTime" === g.plotInfo.axisXValueType ||
